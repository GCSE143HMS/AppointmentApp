...
public class DoctorViewRejectedAppointmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_view_rejected_appointments);
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                if (!queryDocumentSnapshots.isEmpty()) {
                                    ...
                                    for (DocumentSnapshot d : list) {
                                        ...
                                        if (objClass.getStatus().equals("Rejected") && objClass.getDoctorId().equals(userId)) {
