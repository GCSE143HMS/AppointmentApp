...
public class UserViewPrescriptionActivity extends AppCompatActivity {
    private Button viewBtn;
    private ListView list_view;
    private String[] data,array,app_Ids;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_view_prescriptions);
        ...
        list_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getApplicationContext(), UserViewPrescriptionActivity1.class);
                appId = app_Ids[position];
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                if (!queryDocumentSnapshots.isEmpty()) {
                                    ...
                                    for (DocumentSnapshot d : list) {
                                        ...
                                        if (objClass.getStatus().equals("PrescriptionUpdated") && objClass.getUserId().equals(userId)) {
                                            ShowDataString = "Patient Name : " + objClass.getPatientName() + " " +
                                                    "\nGender : " + objClass.getPgender() +
