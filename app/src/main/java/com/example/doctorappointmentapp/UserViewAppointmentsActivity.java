...
public class UserViewAppointmentsActivity extends AppCompatActivity {
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                if (!queryDocumentSnapshots.isEmpty()) {
                                    ...
                                    for (DocumentSnapshot d : list) {
                                        ...
                                        if(objClass.getUserId().equals(userId)) {
                                            ShowDataString = "Doctor Name : " + objClass.getDoctorName() +
