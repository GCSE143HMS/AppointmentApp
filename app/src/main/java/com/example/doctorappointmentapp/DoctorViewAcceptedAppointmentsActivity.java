...
public class DoctorViewAcceptedAppointmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_view_accepted_appointments);
        ...
        list_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getApplicationContext(), DoctorViewAcceptedAppointmentsActivity1.class);
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                if (!queryDocumentSnapshots.isEmpty()) {
                                    ...
                                    for (DocumentSnapshot d : list) {
                                        ...
                                        if (objClass.getStatus().equals("Accepted") && objClass.getDoctorId().equals(userId)) {
